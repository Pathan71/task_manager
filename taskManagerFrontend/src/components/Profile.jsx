import { ChevronLast, UserCircle, User, Mail, Save, Shield, Lock, LogOut } from 'lucide-react'
    ...
    <div className='min-h-screen bg-gray-50'>
      ...
      <div className='max-w-4xl mx-auto p-6'>
        <button onClick={() => navigate(-1)}
          ...
          <ChevronLast className='w-5 h-5 mt-1' />
          Back to Dashboard
        </button>
            ...
            <form onSubmit={changePassword} className='space-y-4'>
              {securityFields.map(({name, placeholder}) => (
                <div key={name} className="flex items-center border border-purple-100 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:ring-purple-500 focus-within:border-purple-500 transition-all duration-200">
                  ...
                  <input type='password' placeholder={placeholder} value={password[name]}
              ...
              <div className='mt-8 pt-6 border-t border-purple-100'>
                ...
                <button className='w-full text-red-600 border border-red-200 py-2.5 rounded-lg hover:bg-red-50 transition-colors duration-200'
                onClick={onLogout}>
                  Logout
                </button>
              </div>
