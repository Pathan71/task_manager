      ...
      {menuItems.map(({ text, path, icon }) => (
        <li key={text}>
          <NavLink to={path} className={({ isActive }) => [
            ...
            isMobile ? 'justfiy-start' : 'lg:justify-start'
    ...
    <>
            ...
            <div className='bg-gradient-to-r from-purple-50 to-fuchsia-50 rounded-xl p-4 border border-purple-100'>
              <div className='flex items-center gap-2'>
                ...
                <div>
                  ...
                  <a href="http://github.com/Pathan71" target='_blank'
      ...
      {mobileOpen && (
        <div className='fixed inset-0 z-40'>
          ...
          <div className='absolute top-0 left-0 w-64 h-full bg-white/90 backdrop-blur-md border-r border-purple-100 shadow-lg z-50 p-4 flex flex-col space-y-6'
